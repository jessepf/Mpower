...
function ($scope, $stateParams, $cordovaSocialSharing) {
	...
	$scope.share = function() {
		$cordovaSocialSharing.share('Hi! I am learning more about how I can contribute to the community of persons with disability with Mpower app! Acceptance, Accessibility, Advocacy for all! Install now to know more: http://provisionasia.org/share/mpower ! ');
	}
